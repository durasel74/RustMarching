...
use open_gl::{ ShaderProgram, ViewPort };
...
fn main() {
    ...
    let vert_filename = Path::new("Shaders/demo.vert").to_str().unwrap();
    let frag_filename = Path::new("Shaders/demo.frag").to_str().unwrap();
